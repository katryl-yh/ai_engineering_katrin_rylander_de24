# 📝 Job Ad Analysis: Ads2

        ---

        ## **Summary by Gemini**

        *   **Role**: Engineering Operations Technician, Data Center Engineering Operations
*   **Summary**: Serve as a technical resource in mission-critical data centers in Västerås and other Swedish locations, ensuring overall availability and reliability of data center engineering operations, maintaining facilities, and improving efficiencies.

*   **Key Responsibilities**:
    *   Operate, maintain, monitor, and troubleshoot electrical, mechanical, HVAC, fire/life safety, cooling, voice/data systems, and generators to ensure high uptime (99.999%).
    *   Assist with maintenance and monitoring of all data center systems, including incident/event management, problem resolution, and change implementation.
    *   Provide support to contractors and data center engineers for equipment operation, maintenance, and deployment of new infrastructure (e.g., racks, cabling).
    *   Conduct site walk-throughs, monitor alarms, and act as a first responder to critical facility events.
    *   Plan and coordinate vendor works, support other sites/teams, and facilitate new equipment handover.
    *   Perform rack power-up and installation duties.
    *   Participate in event response and drills, and contribute to knowledge sharing.

*   **Mandatory Qualifications**:
    *   2+ years of relevant experience in electrical, mechanical, and/or controls.
    *   Ability to prioritize tasks in a complex, fast-paced environment.
    *   Valid EU driving license.
    *   Willingness to cover 24x7 shift rotation.
