# 📝 Job Ad Analysis: Ads1

        ---

        ## **Summary by Gemini**

        *   **Role Summary:** A Data Engineer with a strong interest and experience in Analytics Engineering, responsible for shaping and building a modern data platform at Instabee to serve various stakeholders for BI, data science, and product integration purposes.
*   **Key Responsibilities:**
    *   Lead the establishment of integration patterns and build/migrate source integrations for the data platform.
    *   Contribute to setting up and maintaining data platform infrastructure.
    ...
    *   Apply data transformation and modeling techniques using DBT with SQL and Python.
    *   Contribute to analytical projects to address business hypotheses and ideas.
*   **Mandatory Qualifications:**
    *   Experience building modern data platforms on GCP and Snowflake.
    *   Proficiency in creating and implementing data platform design patterns.
    *   Experience integrating data from sources like APIs, MongoDB, and MySQL.
    *   Skilled in setting up CI/CD pipelines and employing Infrastructure as Code (IaC).
    *   Experience orchestrating data pipelines with Airflow or similar tools.
    *   Proficient in data modeling with DBT and SQL, and programming with Python (or Java or Go).
    *   Demonstrated experience in both Data Engineering and Analytics Engineering.
    *   University degree in a technical or analytical field (e.g., Mathematics, Computer Science, Physics).
    *   Ability to collaborate with business stakeholders and effectively visualize/communicate findings.
    *   Preference for working with agile methods.
    *   Based in Stockholm and open to hybrid work (3 days from the office).
